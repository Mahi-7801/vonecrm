...
class DashboardController extends Controller
{
    public function index(Request $request)
    {
        ...
        $data = \Illuminate\Support\Facades\Cache::remember('vone_user_dash_' . $user->id, 15, function () use ($user) {
        ...
        $data['balance'] = $user->fresh()->balance;
        $data['credit_mode'] = $user->credit_mode;
